      ...
      <div className="container project-page__inner">
        ...
        <div className="project-page__layout">
          <aside className="project-page__sidebar">
            <div className="project-page__sidebar-sticky">
              <div className="project-page__meta-group">
                <p className="project-page__sidebar-eyebrow">Case Study · {project.caseStudy.year}</p>
                <CharReveal text={project.title} className="project-page__sidebar-title" as="h1" />
                <p className="project-page__sidebar-role">{project.caseStudy.role}</p>
              </div>

              <nav className="project-page__outline-nav" aria-label="Page Outline">
              ...
              <div className="project-page__sidebar-tech">
                <h3 className="outline-title">Technologies</h3>
              ...
              <div className="project-page__sidebar-actions">
                {project.links.map((link) => (
                  ...
                  >
                    {link.label === 'GitHub' ? (
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round" className="mr-2" style={{ marginRight: '0.35rem' }}>
          ...
          <article className="project-page__content">
            <section id="introduction" className="doc-section">
              ...
              <div className="doc-media">
                <img src={project.image} alt={project.title} className="doc-main-image" />
              </div>
            </section>
