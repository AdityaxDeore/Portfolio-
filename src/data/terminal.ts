...
export function getResumeOutput(): string[] {
  return [
    ...
    '',
    'PROJECTS:',
    '  Code Campus — Proctored Coding & Learning Platform | Sept 2025 - Feb 2026',
    '    [React, Node.js, MongoDB, TypeScript] · github.com/AdityaxDeore/codecampus',
    '    · Built a VS Code-style IDE for real-time code execution.',
    '    · Implemented secure proctoring to prevent cheating.',
    '',
    '  Clarity — AI-Powered Mental Wellness Platform | Jan - Apr 2025',
    '    [React, TypeScript, PostgreSQL, TensorFlow] · github.com/AdityaxDeore/Clarity',
    '    · Built AI chatbot support and mood tracking dashboards.',
    ...
    '    · Built an MRI-based tumor classification model (96.3% accuracy).',
